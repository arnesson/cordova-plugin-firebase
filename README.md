...
<plugin name="cordova-plugin-firebase" spec="https://github.com/arnesson/cordova-plugin-firebase">
  <variable name="ANDROID_GOOGLE_APP_ID" value="yourGoogleAppId" />
</plugin>
```
or by running:
```
cordova plugin add https://github.com/arnesson/cordova-plugin-firebase.git --variable ANDROID_GOOGLE_APP_ID="yourGoogleAppId" --save
```
